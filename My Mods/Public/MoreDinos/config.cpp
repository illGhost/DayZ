...
class CfgMods
{
	class MoreDinos
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"MoreDinos/scripts/4_world"};
			};
		};
	};
};
class CfgVehicles
{
	...
	class Animal_dbo_raptorblue_ADULT: Animal_dbo_raptorblue
	{
		...
		class DamageSystem
		{
		    class GlobalHealth
		    {
		        class Health
		        {
		            hitpoints = 1250; // Base hitpoints for the animal
		            healthLevels[] = {{1,{}},{0.7,{}},{0.5,{}},{0.3,{}},{0,{}}};
		        };
		        class Blood
		        {
		    ...
		    class DamageZones
		    {
		        class Zone_Head
		        {
		            ...
		            class Health
		            {
		                hitpoints = 875; // 70% of GlobalHealth hitpoints (1250)
		                transferToGlobalCoef = 1;
		            };
		            class Blood: Health
		            {
		        ...
		        class Zone_Chest: Zone_Head
		        {
		            ...
		            class Health: Health
		            {
		                hitpoints = 1100; // 90% of GlobalHealth hitpoints (1250)
		            };
		        };
		        class Zone_Belly: Zone_Head
		        {
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"MoreDinos\data\peltRaptor\peltRaptor.rvmat"
							}
						},
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"MoreDinos\data\peltTRex\peltTRex.rvmat"
							}
						},
	...
	class MD_Pelt_Raptor: RaptorPelt_base
	{
		...
		{
			"MoreDinos\data\peltRaptor\peltRaptor_co.paa"
		};
		hiddenSelectionsMaterials[] = {"MoreDinos\data\peltRaptor\peltRaptor.rvmat"};
	};
	...
	class MD_Pelt_RaptorB: RaptorPelt_base
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"MoreDinos\data\peltRaptorB\peltRaptorB_co.paa"
		};
		hiddenSelectionsMaterials[] = {"MoreDinos\data\peltRaptorB\peltRaptorB.rvmat"};
	};
	...
	class MD_Pelt_RaptorBlue: RaptorPelt_base
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"MoreDinos\data\peltRaptorBlue\peltRaptorBlue_co.paa"
		};
		hiddenSelectionsMaterials[] = {"MoreDinos\data\peltRaptorBlue\peltRaptorBlue.rvmat"};
	};
	...
	class MD_Pelt_RaptorIdrex: RaptorPelt_base
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"MoreDinos\data\peltRaptorIdrex\peltRaptorIdrex_co.paa"
		};
		hiddenSelectionsMaterials[] = {"MoreDinos\data\peltRaptorIdrex\peltRaptorIdrex.rvmat"};
	};
	...
	class MD_Pelt_Tricero: TRexPelt_base
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"MoreDinos\data\peltTricero\peltTricero_co.paa",
			"MoreDinos\data\peltTricero\peltTricero_co.paa"
		};
		hiddenSelectionsMaterials[] = {"MoreDinos\data\peltTricero\peltTricero.rvmat"};
	};
	...
	class MD_Pelt_TRex: TRexPelt_base
	{
		...
		hiddenSelectionsTextures[] = 
		{
			"MoreDinos\data\peltTRex\peltTRex_co.paa",
			"MoreDinos\data\peltTRex\peltTRex_co.paa"
		};
		hiddenSelectionsMaterials[] = {"MoreDinos\data\peltTRex\peltTRex.rvmat"};
	};
